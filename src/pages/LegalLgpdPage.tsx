    ...
    <div className="min-h-screen bg-slate-950 px-4 py-10">
      <div className="mx-auto w-full max-w-3xl">
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-slate-400">Material de apoio. Última atualização: 18/02/2026.</p>
        </div>

        <Card className="border border-slate-800 bg-slate-900">
          <p className="text-sm text-slate-300">
            Se você for titular de dados (ex.: paciente), a LGPD garante direitos. Em ambientes de laboratório e clínica,
            as solicitações podem precisar ser tratadas em conjunto entre controlador e operador.
          </p>
          ...
          <Section title="Como solicitar">
            <ol className="list-decimal pl-5">
              ...
              <li>Use o canal de privacidade definido no contrato ou pela clínica.</li>
              <li>Para segurança, pode ser solicitada confirmação de identidade.</li>
            </ol>
          </Section>
