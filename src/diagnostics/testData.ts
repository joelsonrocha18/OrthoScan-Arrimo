...
export function createDiagnosticsTestData() {
  ...
  const users: User[] = [
    ...
    },
    {
      ...
      name: 'DIAG_TEST Dentista cliente',
    ...
    },
    {
      ...
      name: 'DIAG_TEST Clínica cliente',
