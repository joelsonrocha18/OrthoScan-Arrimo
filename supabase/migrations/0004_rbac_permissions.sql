...
insert into permissions (key, label, module) values
  ('dashboard.read', 'Visualizar painel', 'Painel'),
  ...
  ('clinics.read', 'Visualizar clínicas', 'Clínicas'),
  ('clinics.write', 'Cadastrar/editar clínicas', 'Clínicas'),
  ('clinics.delete', 'Excluir clínicas', 'Clínicas'),
  ...
  ('scans.read', 'Visualizar escaneamentos', 'Exames'),
  ('scans.write', 'Enviar escaneamentos', 'Exames'),
  ('scans.approve', 'Aprovar escaneamentos', 'Exames'),
  ('cases.read', 'Visualizar casos', 'Casos'),
  ('cases.write', 'Criar/editar casos', 'Casos'),
  ('lab.read', 'Visualizar laboratório', 'Laboratório'),
  ('lab.write', 'Gerenciar laboratório', 'Laboratório'),
  ('docs.read', 'Visualizar documentos', 'Documentos'),
  ('docs.write', 'Gerenciar documentos', 'Documentos'),
  ('users.read', 'Visualizar usuários', 'Usuários'),
  ('users.write', 'Cadastrar/editar usuários', 'Usuários'),
  ('users.delete', 'Excluir usuários', 'Usuários'),
  ('settings.read', 'Visualizar configurações', 'Configurações'),
  ('settings.write', 'Gerenciar configurações', 'Configurações')
